    ...
    return (
      <div className="min-h-[80vh] flex items-center justify-center px-4">
        <div className="text-center max-w-sm">
          ...
          <Link href="/" className="mt-6 inline-block text-blue-600 dark:text-blue-400 text-sm font-medium hover:underline">
            Back to home
          </Link>
        </div>
      </div>
    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Join the tech community</p>
        </div>
